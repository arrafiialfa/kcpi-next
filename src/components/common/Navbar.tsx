...
export default function Navbar() {
  return (
    <nav className=" z-0 fixed top-0 left-0 w-full bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit ">
      <div className=" text-sm px-4 xl:w-3/5 lg:w-3/4 md:w-4/5 mx-auto flex  justify-center gap-x-6 ">
        ...
        <div className="flex flex-row-reverse flex-wrap items-center gap-4 text-slate-600">
